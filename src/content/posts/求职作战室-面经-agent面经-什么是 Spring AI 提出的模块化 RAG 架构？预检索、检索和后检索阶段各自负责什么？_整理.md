---
title: "什么是 Spring AI 提出的模块化 RAG 架构？预检索、检索和后检索阶段各自负责什么？"
published: 2026-06-12
description: "什么是 Spring AI 提出的模块化 RAG 架构？预检索、检索和后检索阶段各自负责什么？ 什么是 Spring AI 提出的模块化 RAG 架构？预检索、检索和后检索阶段各自负责什么？VIP中等后端编程导航标记分享151441Spring AI 提出的模块化 RAG 架构是将整个检索增强生成过程分解为预检索、检索、检索后三个核心阶段，每个阶段包含可配置的组件，以提升大模型响应的准确性和灵活性..."
category: "求职作战室"
tags: ["\u6c42\u804c\u4f5c\u6218\u5ba4", "\u9762\u7ecf"]
draft: false
lang: zh-CN
