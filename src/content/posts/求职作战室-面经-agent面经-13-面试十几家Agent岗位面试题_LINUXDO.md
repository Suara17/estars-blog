---
title: "面试十几家 Agent 岗位，整理了面试题～"
published: 2026-06-11
description: "来自 LINUX DO 的 Agent 岗位面试题合集，覆盖 ML、KJ、JR、TK、YC、HJ、FN、XZ、SH、PY、HQ、YU 等 10+ 家公司，包含 Agent 架构、LangChain/RAG、K8s、WebSocket、前端八股、秒杀系统设计等面试题。"
tags: ["求职作战室", "面经", "agent面经"]
category: "求职作战室"
draft: false
lang: zh-CN
pinned: false
