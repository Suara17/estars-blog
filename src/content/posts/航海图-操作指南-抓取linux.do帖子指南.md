...
description: "> 适用场景：用户发来 linux.do 帖子链接，要求抓取帖子内容和评论并保存。 --- linux.do 是 Discourse 论坛，部署在 Cloudflare 后面。直接用 curl 访问会返回 403，浏览器打开也会卡在 "Just a moment..." 验证页。 Discourse 论坛有内置 JSON API：https://linux.do/t/<topic_id>.json..."
category: "航海图"
tags: ["\u822a\u6d77\u56fe", "\u64cd\u4f5c\u6307\u5357"]
draft: false
lang: zh-CN
