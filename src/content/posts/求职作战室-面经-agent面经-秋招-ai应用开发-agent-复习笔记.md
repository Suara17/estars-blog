---
title: "求职作战室｜秋招 AI应用开发 Agent 复习笔记"
...
1. [Agent 核心概念与架构](#1-agent-核心概念与架构)
2. [Agent 四种范式深度对比](#2-agent-四种范式深度对比)
...
8. [Multi-Agent 多智能体架构](#8-multi-agent-多智能体架构)
9. [幻觉处理](#9-幻觉处理)
10. [上下文管理](#10-上下文管理)
11. [工程化与可靠性设计](#11-工程化与可靠性设计)
12. [Agent 评测体系](#12-agent-评测体系)
13. [项目面试话术](#13-项目面试话术)
14. [算法 / CS 基础高频点](#14-算法--cs-基础高频点)
15. [各家大厂面经速览](#15-各家大厂面经速览)
16. [贴心避坑指南](#16-贴心避坑指南)
...
1. **写入时机**：不是所有信息都值得存 → 需要**重要性打分+去重**
2. **检索方式**：**相关性和时效性要兼顾** → 时间衰减权重
